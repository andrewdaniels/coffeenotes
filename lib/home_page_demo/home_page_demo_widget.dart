                  ...
                  Expanded(
                    child: StreamBuilder<List<CoffeeNotesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CoffeeNotesRecord> cardCoffeeNotesRecordList =
                            snapshot.data;
                        // Customize what your widget looks like with no query results.
                        if (snapshot.data.isEmpty) {
                          // return Container();
                          // For now, we'll just include some dummy data.
                          cardCoffeeNotesRecordList =
                              createDummyCoffeeNotesRecord(count: 1);
                        }
                        final cardCoffeeNotesRecord =
                            cardCoffeeNotesRecordList.first;
                        return Padding(
